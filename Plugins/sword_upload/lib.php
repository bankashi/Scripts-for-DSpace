...
/**
 * Este plugin fue actualizado a una segunda versión de la primera versión de Marcelo A. Rauh Schmitt. Esta actualización cuentan con el soporte a los recientes (5.6 & 7.0), al METS del sword:swap de los dspace 6.x y al moodle 3.0.10 ~ 3.4
 *
 * @since       2.0
 * @package     repository_sword_upload
 * @copyright   2018 Huriviades
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 */
...
class repository_sword_upload extends repository {
    ...
    public function __construct($repositoryid, $context = SYSCONTEXTID, $options = array()) {
        ...
        require_once($CFG->dirroot . '/repository/sword_upload/sword/swordappclient.php');
    ...
    public function print_login($nao_login = true) {
	    ...
	    $username->attributes = array('size'=>'16');
            ...
            $password->id   = 's_password';
            $password->name = 's_password';
    ...
    */
	...
	$description->rows = 20;
        ...
        $type->options = array(
            ...
            (object)array(
                'value' => 'Contribution To Periodical',
                'label' => 'Contribution To Periodical'
            ),
            (object)array(
                'value' => 'Patent',
                'label' => 'Patent'
    ...
    private function deposit_process() {
        ...
        require_once($CFG->dirroot . '/repository/sword_upload/sword/packager_mets_swap.php');
        ...
        if (!empty($SESSION->entry['license-uri'])) {
            ...
            $swordPackager->addRights($SESSION->entry['license-uri']);
        }
    ...
    public function upload($saveas_filename, $maxbytes) {
        ...
        require_once($CFG->dirroot . '/repository/sword_upload/sword/packager_mets_swap.php');
        require_once($CFG->dirroot . '/repository/sword_upload/sword/utils.php');
